...
dd = npy4th.loadnpy('/home/weiz/rui/SPEED_CROSS.npy')
y = {}
...
for k,v in pairs(paths.dir(dir)) do
        ...
        train_x[n] = train_x[n]:transpose(1,2):contiguous()
...
for k,v in pairs(paths.dir(dir)) do
        ...
        test_x[n] = test_x[n]:transpose(1,2):contiguous():cuda()
...
for k,v in pairs(paths.dir(dir)) do
        ...
        valid_x[n] = valid_x[n]:transpose(1,2):contiguous():cuda()
